 ...
 *
 * Load tiers are driven by the engine. Mounted media remains mounted while
 * scrolling so completed generations do not flash back to placeholders.
 */
...
async function shareItem(item: GalleryItem): Promise<void> {
  ...
  if (navigator.share != null) {
    await navigator.share({ title: "Generated media", text: item.prompt, url });
    return;
  }
