...
/** The PortraitVoice registry: portrait re-frame + talking-head video engines. */
export const APP_DETAIL_JOBS = PORTRAITVOICE_JOBS;
...
/** User and workspace form the cache isolation boundary for all live data. */
